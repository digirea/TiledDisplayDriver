...
%\begin{figure}[htbp]
%	\begin{center}
%		\includegraphics[width=11.5cm]{image/controller.png}
%	\end{center}
%	\caption{ホーム画面}
...
%\begin{figure}[htbp]
%	\begin{center}
%		\includegraphics[width=11.5cm]{image/display.png}
%	\end{center}
%	\caption{ディスプレイ}
%	\label{fig:display}
%\end{figure}
...
%\begin{figure}[htbp]
%	\begin{center}
%		\includegraphics[width=11.5cm]{image/connection.png}
%	\end{center}
%	\caption{ホーム画面}
%	\label{fig:home}
%\end{figure}
...
%\begin{figure}[htbp]
%	\begin{center}
%		\includegraphics[width=11.5cm]{image/snap.png}
%	\end{center}
%	\caption{スナップ配置}
%	\label{fig:snap}
%\end{figure}
